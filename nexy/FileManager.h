...
class FileManager {
    ...
    public:
                                ...
                                FileManager(const std::string &fn);                                                                                     //!< Constructor with file/directory name
                                FileManager(const std::string &pn, const std::string &fn);                                                              //!< Constructor with path name and file/directory name
